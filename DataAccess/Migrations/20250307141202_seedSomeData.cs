    ...
    public partial class seedSomeData : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "CompanyId", "CreatedBy", "MaintenanceSchedule", "PackageName", "PaymentFrequency", "PolicyPrice" },
                values: new object[,]
                {
                    { 1, 1, "Company", 2, "Basic Plan", 0, 1000.0 },
                    { 2, 1, "Company", 1, "Premium Plan", 1, 2500.0 },
                    { 3, 1, "Company", 0, "Pro Plan", 3, 4000.0 },
                    { 4, 2, "Company", 1, "Silver Package", 0, 1200.0 },
                    { 5, 2, "Company", 2, "Gold Package", 1, 2800.0 },
                    { 6, 2, "Company", 0, "Platinum Package", 3, 5000.0 },
                    { 7, 3, "Company", 1, "Starter Plan", 0, 800.0 },
                    { 8, 3, "Company", 2, "Family Plan", 1, 3000.0 },
                    { 9, 3, "Company", 0, "Elite Plan", 3, 5500.0 },
                    { 10, 4, "Company", 1, "Standard Cover", 0, 1500.0 },
                    { 11, 4, "Company", 2, "Advanced Cover", 1, 3200.0 },
                    { 12, 4, "Company", 0, "Executive Cover", 3, 6000.0 },
                    { 13, 5, "Company", 1, "Basic Shield", 0, 900.0 },
                    { 14, 5, "Company", 2, "Comprehensive Shield", 1, 3500.0 },
                    { 15, 5, "Company", 0, "Ultimate Shield", 3, 7000.0 }
                });
        }
